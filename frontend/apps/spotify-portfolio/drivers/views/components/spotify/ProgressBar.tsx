    ...
    <div className="flex grow flex-col-reverse items-center gap-y-3 self-stretch">
      ...
      <div className="flex items-center gap-x-3 text-sm text-gray-800">
        <button
          ...
          disabled={true}
          className={twMerge(
            'inline-flex size-12 cursor-not-allowed items-center justify-center rounded-full border contrast-more:border-black',
        ...
        >
          {result?.isPlaying ? (
            ...
            <div className="ml-4 size-0 scale-x-150 border-8 border-transparent border-l-black"></div>
          )}
